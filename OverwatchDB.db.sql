...
','Healing: 60 health per second.','Max. range: 15 meters.','Duration: until cancelled.','Damage: +30% damage boost.','Primary fire creates a healing tether on the ally closest to Mercy''s crosshairs, which remains for as long as Mercy holds down the primary fire button.','Secondary fire creates a damage tether that works similarly to the healing tether, but boosts damage instead of healing.',NULL,NULL,NULL,NULL);
