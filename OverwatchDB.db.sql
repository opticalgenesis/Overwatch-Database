...
INSERT INTO `Overwatch_League_Teams` VALUES (20,'19','Titans','5',NULL,'0A226C','2FB228','FEFEFE');
...
INSERT INTO `Hero_Abilities` VALUES (8,29,'The Viper',6,'Ashe can use her aim-down sights for a more damaging, precise shot.','Damage: 42.5 - 85.','Same reload mechanic as the automatic fire.','Can headshot.','Move. speed: -20%.','Falloff range: 30 to 60 meters.','',NULL,NULL);
...
INSERT INTO `Hero_Abilities` VALUES (34,28,'Widow''s Kiss',1,'Should targets close to medium range, the rifle can also be fired in fully-automatic mode.','Reload time: 1.5 seconds.','Can headshot.','Rate of fire: 10 rounds per second.','Damage: 6.5 - 13.',NULL,NULL,NULL,NULL);
...
INSERT INTO `Hero_Abilities` VALUES (52,4,'Shield Bash',3,'Once her Barrier Shield is deployed, Brigitte can dash forward to stun an enemy.','Damage: 5.','Max. range: 6 meters.','Duration: 1 second stun.','Cooldown: 7 seconds.','Shield Bash not only stuns the target struck by it, it also inflicts a small amount of knockback.','If Shield Bash interacts with Reinhardt''s Charge, Doomfist''s Rocket Punch, Ashe''s B.O.B., or another Shield Bash, both heroes get knocked down.',NULL,NULL);
...
INSERT INTO `Hero_Abilities` VALUES (83,7,'Light Gun',2,'While outside of her mech, D.Va can continue the fight with a mid-range automatic blaster.','Light Gun damage counts toward Call Mech, but D.Va''s passive ultimate charge counts toward both Self Destruct and Call Mech.','Damage: 14.','Can headshot.','Reload time: 1.5 seconds.','Ammo: 20.',NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (84,7,'Call Mech',5,'If her armored battle suit is destroyed, D.Va can call down a fresh mech and return to the fray.','Call Mech can be used instantly after the mech detonates from Self Destruct.','Automatically reloads the Light Gun.','Casting time: 2 seconds.','Damage: 50.','',NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (85,12,'Tesla Cannon',1,'Winston’s weapon fires a short-range electric barrage for as long as he holds down the trigger.','Damage: 60 per second.','Ammo: 100.','Ammo usage: 20 rounds per second.','Can''t headshot.','1.5 seconds.','Area of effect: 6 meter width.','',NULL);
INSERT INTO `Hero_Abilities` VALUES (86,12,'Jump Pack',3,'Assisted by his energy pack, Winston lunges through the air, dealing significant damage and staggering nearby enemies when he lands.','Damage: 1 upon activating, Up to 45 upon landing, falloff with distance.','Cooldown: 6 seconds (2 seconds during primal rage).',NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (87,12,'Barrier Projector',3,'Winston’s barrier projector extends a bubble-shaped field that absorbs damage until it''s destroyed. Allies protected by the barrier can return fire from within it.','Health: 600.','Area of effect: 5 meter radius.','Cooldown: 13 seconds.',NULL,NULL,NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (88,12,'Primal Rage',5,'Winston embraces his animal nature, significantly boosting his health and making him very difficult to kill, strengthening his melee attack, and allowing him to use his Jump Pack ability more frequently. While raging, Winston can only make melee and Jump Pack attacks.','Health: 900 health + 100 armor.','Damage: 40 per swing.','Duration: 10 seconds.','Also lowers the cooldown on Jump Pack to 2 seconds.','Resets Jump Pack cooldown on activation.','Winston cannot use Barrier Projector while Primal Rage is active.','Winston''s HP after Primal Rage is based on his HP at the end of the duration.','Ammunition is restored after completion.');
INSERT INTO `Hero_Abilities` VALUES (89,19,'Total Mayhem',4,'Junkrat''s deranged sense of humor persists past his death. If killed, he drops several live grenades.','Also causes Junkrat to not take damage from his own explosions.','Damage: 50 per grenade.','Num. of pellets: 6 grenades.',NULL,NULL,NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (90,19,'Frag Launcher',1,'Junkrat''s Frag Launcher lobs grenades a significant distance. They bounce to reach their destination, and blow up when they strike an enemy.','Damage: Direct hit: 120, Splash max: 80, Splash min: 12.5.','Ammo: 5.','Reload time: 1.5 seconds.','The grenades explode after three bounces or when they hit an enemy unit.',NULL,NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (91,19,'Concussion Mine',3,'After placing one of his homemade Concussion Mines, Junkrat can trigger it to damage enemies and send them flying... or propel himself through the air.','Ammo: 2 charges.','Damage: Splash max: 120, Splash min: 35.','Area of effect: 3 meters.','The mine does not deal self-damage, but still applies the knockback, making it usable as a mobility tool.','Cooldown: 8 seconds for one charge.',NULL,NULL,NULL);
INSERT INTO `Hero_Abilities` VALUES (92,19,'Steel Trap',3,'Junkrat tosses out a giant, metal-toothed trap. Should an enemy wander too close to the trap, it clamps on, injuring and immobilizing them.','Health: 100.','Damage: 80.','Junkrat can see the trap''s location through walls.','The player receives an audio cue when an enemy triggers the trap.','Cooldown: 10 seconds.',NULL,NULL,NULL);
...
','Cannot be targeted (thus destroyed) by Soldier 76''s Tactical Visor or McCree''s Deadeye.','Ammunition is restored after completion.','Casting time: 1 seconds.',NULL,NULL);
